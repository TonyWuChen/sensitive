...
public class SensitivewordFilter {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String string = "dfa是面向三级装配的设计(Design for assembly)的英文简称，是指在产品设计阶段设计产品使得产品具有良好" +
                "的可装配性，确保装配工序简单、装配效率高、装配质量高、装配不良率低和装配成本低。面向装配的设计通过一系" +
                "列有利于装配的设计指南例如简化产品设计、减少零件数量等，女女并同装配工程师一起合作，被逼简化产品结构，近親使其便于" +
